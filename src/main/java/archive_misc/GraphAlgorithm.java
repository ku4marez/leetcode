...
public class GraphAlgorithm {
    ...
    static void dfs(int node, boolean[] visited, Map<Integer, List<Integer>> graph) {
        visited[node] = true;
    ...
    static int countComponents(int node, boolean[] visited, Map<Integer, List<Integer>> graph, int count) {
        visited[node] = true;
        for (int adj : graph.get(node)) {
            if (!visited[adj]) {
    ...
    static boolean hasCycleUndirected(int node, int parent, boolean[] visited, Map<Integer, List<Integer>> graph) {
        visited[node] = true;
        for (int adj : graph.get(node)) {
            if (!visited[adj]) {
    ...
    static boolean hasCycleDirected(int n, int[] visited, Map<Integer, List<Integer>> graph) {
    ...
    static void topologicalSort(int n, boolean[] visited, Map<Integer, List<Integer>> graph, Stack<Integer> stack) {
        visited[n] = true;
        for (int adj : graph.get(n)) {
            if (!visited[adj]) {
    ...
    static int shortestPathUnweighted(int n, int[][] edges, int src, int dest) {
        Map<Integer, List<Integer>> graph = buildAdjList(n, edges);
    ...
    static int countComponentsUnionFind(int n, int[][] edges) {

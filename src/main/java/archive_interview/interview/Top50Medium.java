...
import archive_interview.preparation.Day8;
...
public class Top50Medium {
    ...
    static List<int[]> groupDigits(String n) {
    ...
    static String buildNext(List<int[]> nums) {
    ...
    static void countIslands(char[][] grid, int i, int j, boolean[][] visited) {
    ...
    static void permute(int[] nums, List<Integer> temp, List<List<Integer>> res, boolean[] visited) {
    ...
    static void backtrack(int[] nums, int index, List<Integer> temp, List<List<Integer>> result) {
    ...
    static void generateParenthesis(List<String> res, StringBuilder sb, int left, int right, int n) {
        if (sb.length() == n * 2) {
            res.add(sb.toString());
            return;
        }
    ...
    static boolean exist(char[][] board, String word, int x, int y, int index) {
    ...
    static void backtrackLetterCombinations(String digits, int index, StringBuilder sb, String[] mapping, List<String> result) {
